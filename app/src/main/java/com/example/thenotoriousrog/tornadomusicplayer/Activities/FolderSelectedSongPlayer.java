...
public class FolderSelectedSongPlayer extends Activity implements AdapterView.OnItemClickListener {
    ...
    public FolderSelectedSongPlayer(MediaPlayer mp, ArrayList<SongInfo> songToPick, ArrayList<String> songpaths, SlidingUpPanelLayout layout, MusicPlayer activity, PanelSlidingListener psl, MainUIFragment fragment)
    {
