...
public class ManualEntry extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.example.thenotoriousrog.tornadomusicplayer.R.layout.manual_entry); // display the window so a user can add the path to their music folder.

        enteredPath = (EditText) findViewById(com.example.thenotoriousrog.tornadomusicplayer.R.id.enteredPath); // view for the EditText field.
        submit = (Button) findViewById(com.example.thenotoriousrog.tornadomusicplayer.R.id.Submit); // view for the Submit button.
    ...
    public void sendPath(String path)
    {
        ...
        setContentView(com.example.thenotoriousrog.tornadomusicplayer.R.layout.activity_main);
